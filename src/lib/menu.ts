...
export const MENU: Section[] = [
  {
    ...
    items: [
      ...
      // PDV/Nova Venda sai do menu (pedido 17/07): o acesso é pelo botão "Nova Venda" no header.
    ...
    items: [
      {
        label: 'Cadastros básicos', icon: 'ti-folders', key: 'cad', children: [
          { label: 'Anamnese / Ficha Técnica', href: '/cadastros/anamnese', icon: 'ti-file-text', perm: 'comercial.' },
          { label: 'Categorias de Contas a pagar', href: '/cadastros/categorias-pagar', icon: 'ti-category', perm: 'financeiro.' },
          { label: 'Categorias de Contas a receber', href: '/cadastros/categorias-receber', icon: 'ti-category-2', perm: 'financeiro.' },
          { label: 'Parcerias', href: '/cadastros/parcerias', icon: 'ti-heart-handshake', perm: 'comercial.' },
          { label: 'Formas de pagamento', href: '/cadastros/formas-pagamento', icon: 'ti-credit-card', perm: 'financeiro.' },
          { label: 'Grupo de serviços', href: '/cadastros/grupo-servicos', icon: 'ti-list-details', perm: 'comercial.' },
          { label: 'Matriz de comissões', href: '/cadastros/comissoes', icon: 'ti-table', perm: 'financeiro.' },
          { label: 'Metas', href: '/cadastros/metas', icon: 'ti-target', perm: 'comercial.' },
          { label: 'Modelos de contrato', href: '/cadastros/contratos', icon: 'ti-file-description', perm: 'comercial.' },
          { label: 'Motivos de cancelamento', href: '/cadastros/motivos', icon: 'ti-circle-x', perm: 'comercial.' },
          { label: 'Planos de Assinatura', href: '/cadastros/planos', icon: 'ti-id-badge-2', perm: 'comercial.' },
          { label: 'Perfis de acesso', href: '/cadastros/perfis', icon: 'ti-shield-lock', perm: 'sistema.cargo' },
          { label: 'Origens de Cliente', href: '/cadastros/origens', icon: 'ti-route', perm: 'comercial.' },
        ],
      },
      ...
      { label: 'Contas da Unidade (pagar/receber)', href: '/contas', icon: 'ti-cash', perm: 'financeiro.', title: 'Contas a pagar/receber · Unidade' },
    ...
    items: [
      {
        label: 'Relatórios', icon: 'ti-chart-bar', key: 'rel', children: [
          { label: 'Assinaturas', href: '/relatorios/assinaturas', icon: 'ti-id-badge-2', perm: 'comercial.' },
          { label: 'Ocorrências e Intercorrências', href: '/relatorios/ocorrencias', icon: 'ti-clipboard-heart', perm: 'comercial.' },
          { label: 'Agendamentos', href: '/relatorios/agendamentos', icon: 'ti-calendar', perm: 'comercial.' },
          { label: 'Anamnese / Ficha Técnica', href: '/relatorios/anamnese', icon: 'ti-file-text', perm: 'comercial.' },
          { label: 'Atendimentos', href: '/relatorios/atendimentos', icon: 'ti-user-cog', perm: 'comercial.' },
          { label: 'Avaliações', href: '/relatorios/avaliacoes', icon: 'ti-speakerphone', perm: 'comercial.' },
          { label: 'Clientes', href: '/relatorios/clientes', icon: 'ti-bookmark', perm: 'comercial.' },
          { label: 'Contratos', href: '/relatorios/contratos', icon: 'ti-file-description', perm: 'comercial.' },
          { label: 'Crédito em dinheiro', href: '/relatorios/credito-dinheiro', icon: 'ti-coins', perm: 'comercial.' },
          { label: 'CRM', href: '/relatorios/crm', icon: 'ti-affiliate', perm: 'comercial.' },
          { label: 'Crédito Recorrente', href: '/relatorios/credito-recorrente', icon: 'ti-credit-card', perm: 'comercial.' },
          { label: 'Descontos', href: '/relatorios/descontos', icon: 'ti-discount', perm: 'comercial.' },
          { label: 'Estatísticas', href: '/relatorios/estatisticas', icon: 'ti-chart-line', perm: 'comercial.' },
          { label: 'Exportações', href: '/relatorios/exportacoes', icon: 'ti-download', perm: 'comercial.' },
          { label: 'Faturamento', href: '/relatorios/faturamento', icon: 'ti-currency-dollar', perm: 'financeiro.' },
          { label: 'Ranking de Vendas', href: '/relatorios/ranking-vendas', icon: 'ti-medal', perm: 'comercial.' },
          { label: 'Fidelidade', href: '/relatorios/fidelidade', icon: 'ti-thumb-up', perm: 'comercial.' },
          ...
          { label: 'Perfis de acesso', href: '/relatorios/perfis-acesso', icon: 'ti-users', perm: 'comercial.' },
        ],
      },
      {
        label: 'Dashboards', icon: 'ti-gauge', key: 'dash', children: [
          { label: 'Financeiro / Contábil', href: '/dashboards/financeiro', icon: 'ti-report-money', perm: 'financeiro.' },
          { label: 'Gerencial', href: '/dashboards/gerencial', icon: 'ti-chart-pie', perm: 'comercial.' },
          { label: 'Funil de Vendas', href: '/dashboards/funil', icon: 'ti-filter-cog', perm: 'comercial.' },
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Financeiro Franqueadora', icon: 'ti-businessplan', key: 'finfranq', perm: 'financeiro.', children: [
          ...
          { label: 'Contas a Receber (Franqueadora)', href: '/financeiro/receber', icon: 'ti-arrow-down-left', title: 'Financeiro · Contas a Receber' },
          { label: 'Contas a Pagar (Franqueadora)', href: '/financeiro/pagar', icon: 'ti-arrow-up-right', title: 'Financeiro · Contas a Pagar' },
