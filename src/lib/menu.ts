...
export const MENU: Section[] = [
  {
    ...
    items: [
      ...
      { label: 'PDV / Nova Venda', href: '/pdv', icon: 'ti-shopping-cart', badge: 'NOVO', perm: 'operacoes.os' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Notas Fiscais', href: '/notas', icon: 'ti-file-invoice', badge: 'NOVO' },
    ],
  },
  {
    title: 'Administração',
    items: [
      ...
      },
      {
        label: 'Financeiro Franqueadora', icon: 'ti-businessplan', key: 'finfranq', perm: 'financeiro.', children: [
          { label: 'Fluxo de Caixa', href: '/financeiro', icon: 'ti-cash', title: 'Financeiro · Fluxo de Caixa', badge: 'NOVO' },
          { label: 'Contas a Receber', href: '/contas?aba=receber', icon: 'ti-arrow-down-left', title: 'Financeiro · Contas a Receber', badge: 'NOVO' },
          { label: 'Contas a Pagar', href: '/contas?aba=pagar', icon: 'ti-arrow-up-right', title: 'Financeiro · Contas a Pagar', badge: 'NOVO' },
