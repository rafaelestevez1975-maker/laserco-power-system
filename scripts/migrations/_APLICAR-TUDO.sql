-- ============================================================================
-- APLICAR-TUDO — Onda 4 (paridade legado). Gerado para o SQL Editor do Supabase.
-- Cole TUDO e rode. Cada módulo é idempotente (CREATE TABLE IF NOT EXISTS); a
-- maioria já é transacional (BEGIN/COMMIT próprio). 050_expansao já foi aplicada.
-- Se algum bloco falhar, corrija e rode de novo: tabelas existentes são puladas.
-- ============================================================================
...
-- ████████████████████████████████████████████████████████████████████████
-- ██  STORAGE BUCKETS (Disco Virtual, Contratos, mídia do SAC)
-- ████████████████████████████████████████████████████████████████████████
insert into storage.buckets (id, name, public) values
  ('disco-virtual','disco-virtual', false),  -- privado
  ('contratos','contratos', false),          -- privado
  ('sac-midia','sac-midia', true)            -- PÚBLICO (mídia WhatsApp; ver privacidade)
on conflict (id) do nothing;
